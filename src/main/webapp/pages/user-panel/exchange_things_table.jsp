...
<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    ...
    <c:forEach items="${items}" var="item">
        <tr class="table-row bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="owner py-4 px-6">
                    ${item.getOwner().getName()}
            </td>
            <td class="py-4 px-6">
                <div class="flex items-center space-x-2">
                    <button type="button"
                            class="request-exchange text-gray-900 bg-white border border-gray-300 disabled:cursor-not-allowed disabled:bg-gray-200 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-2.5 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
                    >Request exchange
                    </button>
                    <button type="button"
